...
static inline api_result_t sm_enclave_enter (enclave_id_t enclave_id, thread_id_t thread_id, phys_ptr_t hash_addr) {
  return SM_API_CALL(SM_ENCLAVE_ENTER, enclave_id, thread_id, hash_addr, 0, 0, 0);
}
...
static inline api_result_t sm_enclave_load_page (enclave_id_t enclave_id, uintptr_t phys_addr, uintptr_t virtual_addr, uintptr_t os_addr, uintptr_t acl, uintptr_t nonce_phys_addr) {
  return SM_API_CALL(SM_ENCLAVE_LOAD_PAGE, enclave_id, phys_addr, virtual_addr, os_addr, acl, nonce_phys_addr);
}
